        ...
        cartItems: [
          {
            ...
            price: 19.00,
            quantity: 2,
            image: '/img/Cart/redheadphone.png', // Replace with actual image URL
          },
          {
            name: 'Red Beats headphone',
            color: 'Color: red',
          ...
          },
          {
            ...
            price: 19.00,
            quantity: 3,
            image: '/img/Cart/product4.png', // Replace with actual image URL
          },
          {
            name: 'Red Beats headphone',
            color: 'Color: red',
            price: 19.00,
            quantity: 1,
            image: '/img/Cart/product2.png', // Replace with actual image URL
          },
          {
            name: 'Red Beats headphone',
            color: 'Color: red',
            price: 19.00,
            quantity: 1,
            image: '/img/Cart/product3.png', // Replace with actual image URL
          },
        ],
