const products = [
  // Phone Cases
  {
    ...
    images: [
      "/src/assets/images/products/phone_case_sienna.png",
      "/src/assets/images/products/phone_case_agave.png",
    ],
    ...
    tags: ['Slim', 'Light'],
    reviews: [
      { username: 'Alice', Date: '12:01am - 17/11/2024', comment: 'Great product!' },
      { username: 'Bob', Date: '4:55am - 23/11/2024', comment: 'Good value for money.' },
    ], 
  },
  {
    id: 2,
    ...
    images: [
      "/src/assets/images/products/phone_case_ganache.png", 
      "/src/assets/images/products/phone_case_black.png",
      "/src/assets/images/products/phone_case_sienna.png",
      "/src/assets/images/products/phone_case_agave.png",
    ],
    ...
    reviews: [
      { username: 'Anna', Date: '12:01am - 17/12/2024', comment: 'Very durable' },
    ], 
  },
  ...
  // Chargers
  {
    ...
    reviews: [
      { username: 'Alice', Date: '12:01am - 17/11/2024', comment: 'Great product!' },
      { username: 'Dan', Date: '1:55am - 10/1/2025', comment: 'Charge really fast.' },
    ], 
  },
  {
    id: 4,
    ...
    reviews: [
      { username: 'Anne', Date: '2:01am - 17/11/2024', comment: 'Great product!' },
      { username: 'Jane', Date: '6:55am - 23/11/2020', comment: 'Good value for money.' },
    ], 
  },
  ...
  // Screen Protectors
  {
    ...
    reviews: [
      { username: 'Harry', Date: '12:01am - 17/11/2024', comment: 'Great product!' },
    ], 
  },
  {
    id: 6,
    ...
    tags: ['Tempered Glass','Screen Guard', 'Strach Protection'],
    reviews:[
      { username: 'Sophie', Date: '1:41pm - 17/11/2024', comment: 'Very cheap!' },
    ]
  },
  ...
  // Headphones & Earbuds
  {
    ...
    reviews: [
      { username: 'Abby', Date: '12:01am - 17/11/2024', comment: 'Great Quality and the price is affordable too' },
      { username: 'Bob', Date: '4:55am - 23/11/2024', comment: 'Used it since 2023' },
    ], 
  },
  {
    id: 8,
    ...
    tags: ['Wireless','Long battery life', 'Light', 'Portable'],
    reviews: [
      { username: 'Jack', Date: '9:01pm - 17/11/2024', comment: 'Great design!' },
      { username: 'Henry', Date: '6:35pm - 23/11/2024', comment: 'Very durable' },
    ], 
  },
  ...
  // Power Banks
  {
    ...
    images: [
      "/src/assets/images/products/power_bank_black.png",
      "/src/assets/images/products/power_bank_pink.png",
    ],
